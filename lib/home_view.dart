              ...
              switch (snapshot.connectionState) {
                ...
                case ConnectionState.done:
                  if (snapshot.hasError) {
                    ...
                    _meetingDataSource.resources!.clear();
                    connectionIds.clear();
                    _meetingDataSource.appointments!.clear();
                      ...
                      for (var i = 0;
                        ...
                        _meetingDataSource.resources!.add(CalendarResource(
                            ...
                            image: appointment["participantsImages"][i] != null
                                ? NetworkImage(
                                    appointment["participantsImages"][i])
                                : null,
                            color: eventColor));
                                                        ...
                                                        if (snapshot
                                                          ...
                                                          return Column(
                                                            ...
                                                            children: [
                                                              ...
                                                              FutureBuilder(
                                                                  future: FirebaseWrapper.getConnectionsNames(
                                                                      FirebaseWrapper
                                                                          .auth
                                                                          .currentUser!
                                                                          .uid),
                                                                      ...
                                                                      case ConnectionState
                                                                        ...
                                                                        if (snapshot
                                                                          ...
                                                                          connectionsNames = connections
                                                                              ...
                                                                              .toList();
                                                                          return Flexible(
                                                                              child: MyDropDownConnectionsButton(
                                                                            items:
                                                                                connectionsNames,
                                                                            selectedItems:
                                                                                selectedConnections,
                                                                        ...
                                                                        if (snapshot
                                                                          ...
                                                                          try {
                                                                            List<String>
                                                                                reservationsNames =
                                                                                [];
                                                                            for (Map<String, dynamic> reservation
                                                                                in reservations) {
                                                                            ...
                                                                            return Flexible(
                                                                              ...
                                                                              items: reservationsNames,
                                                                              selectedValue: selectedReservation,
                                                                              onSelectedValueChanged: (value) {
                                                                                setState(() {
                                                  ...
                                                  onPressed: () async {
                                                    if (containerHeight > 0) {
                                                      if (eventEndTime.hour <
                                                        ...
                                                        connectionIds.clear();
                                                        String? profileImage;
                                                        profileImage = await FirebaseWrapper
